...
In order to predict probability of booking cancellation XGBoost model have been fitted. Table below details the split of dataset.
...
```{r roc-curve, echo=FALSE, fig.cap='XGBoost: ROC curve.', out.width = '80%', fig.align='center'}
...
```{r roc_curve_tree, echo=FALSE, fig.cap='Decision Tree: ROC curve.', out.width = '80%', fig.align='center'}
...
Let's take one observation and analyze prediction of two models. We have chosen observation number `187`. Both models predicts high probability of booking cancellation (*Decision Tree*: **0.9940**, *Xgboost*: **0.9982**). We will comment on the readability of the *decision tree* explanation by plotting the tree later.

```{r obs, echo=FALSE, fig.cap='The vector of feature values of chosen instance.', out.width = '70%', fig.align='center'}
...
```{r feat_imp, echo=FALSE, fig.cap='SHAP values and break down plot of XGBoost model for instance with the lowest probability of booking cancellation.', out.width = '100%', fig.align='center'}
knitr::include_graphics("images/03-shap_min.png.png")
...
```{r feat_imp, echo=FALSE, fig.cap='SHAP values and break down plot of XGBoost model for instance with the highest probability of booking cancellation.', out.width = '100%', fig.align='center'}
knitr::include_graphics("images/03-shap_max.png.png")
...
```{r balance, echo=FALSE, fig.cap='The distribution of guests that are and are not repeated guest in the dataset', out.width = '50%', fig.align='center'}
...
```{r ex_lime_2_1, echo=FALSE, fig.cap='LIME explanation for the best of the first models', out.width = '100%', fig.align='center'}
...
```{r roc_2, echo=FALSE, fig.cap='ROC curve for the XGBClassifier', out.width = '100%', fig.align='center'}
...
```{r tree_2, echo=FALSE, fig.cap='Plot of the tree of the DecisionTreeClassifier model', out.width = '100%', fig.align='center'}
...
```{r shap_2_1, echo=FALSE, fig.cap='Shapley values for a non-repeating customer', out.width = '100%', fig.align='center'}
...
```{r pci_2, echo=FALSE, fig.cap='Permutational variable importance of most important variables for XGBClassifier', out.width = '100%', fig.align='center'}
